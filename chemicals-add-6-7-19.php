...
/////////////////////////////////////////////////////////////PS DISPOSAL
  ...
  if($pPhrases_dispMax == 5)
  {
    ...
    $pprases_disp_fields = [        
            'pphrase_storage1'=>$pPhrases_disp[0],
            'pphrase_storage2'=>$pPhrases_disp[1],
            'pphrase_storage3'=>$pPhrases_disp[2],
            'pphrase_storage4'=>$pPhrases_disp[3],
            'pphrase_storage5'=>$pPhrases_disp[4],
            'pphrase_storage6'=>$pPhrases_disp[5]
...
*/
  $user_id_session = $_SESSION['user_id'];
   $header_fields = [   
       ...
       $ch->insertProperties($properties_fields);
       $ch->insertPhrases($phrases_fields);
       $ch->insertGhs($ghs_fields);
