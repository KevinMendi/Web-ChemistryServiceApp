        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12">
                        ...
                        <div class="body">
                            <a href=""><img src="assets/images/emprof/Jessamine.jpg" class="rounded-circle shadow " alt="profile-image" height="150" width="150" style=""></a>
                            <h4 class="m-t-10">Jessamine Joy Cena</h4>                            
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><strong>SSS, TIN & PHILHEALTH</strong></h2>
                        </div>
                        <div class="body">
                            <center>
                            <p>SSS Number: 08-2956590-4</p>
                            <p>TIN: 747-386-294-0000</p>
                            <p>PhilHealth: 16-050625113-0</p>
                            </center>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <center>
                            <p>Contact Number: +639973891649</p>
                            </center>
                            <center>
                            <p><i>IN CASE OF EMERGENCY</i></p>
                            <p>Name: Maricel S. Cena</p>
                            <p>Contact Number: +639778430044</p>
                            </center>
                        </div>
                    </div>
