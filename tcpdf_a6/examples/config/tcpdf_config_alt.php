 ...
 */
define ('PDF_HEADER_LOGO', 'rimpido-header.png');

/**
 * Header logo image width in user units.
 */
define ('PDF_HEADER_LOGO_WIDTH', 7);
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Rimpido GmbH');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Rimpido GmbH');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Label Printing');
