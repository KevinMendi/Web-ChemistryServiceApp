...
$convertedVolume = $volumeToCubicCM * (double)$volumeValue;
                       ...
                       <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="col-md-12 mb-5">
                                    <input type="text" class="form-control"  name="densityResult" style="height: 70px; font-size: 17px;" readonly value="<?php echo($answerStr); ?>">
                                </div>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <option value="kg/cm">kilogram/centimeter</option>
                                        <option value="kg/m">kilogram/meter</option>
                                        ...
                                        <option value="lb/yd">pound/cubic yard</option>
                                        ...
                                        <option value="ton/yd">short ton/cubic yard</option>
                                        </select>
                                    </div>
                                </div>
                            -->
