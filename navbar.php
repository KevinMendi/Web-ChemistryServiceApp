...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.php"><img src="assets/images/logo.png" width="25" alt="ChemPO"><span class="m-l-10">ChemPO</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    ...
                    ?>
                    <a class="image" href="user-profile.php"><img src="img/users-pic/<?php 
                    if($_SESSION['profile_pic_name'] == "")
                    {
                        echo "default.jpg";
                    }
                    else{
                        echo $_SESSION['profile_pic_name']; 
                    ...
                    <div class="detail">
                        ...
                        <small><?php echo$_SESSION['user_role_name']; ?></small>
                    </div>
                </div>
            </li>
            ...
            <?php
                ...
                {
            ?>
                <li><a href="user-view.php?read=<?php echo $_SESSION['user_id']; ?>"><i class="zmdi zmdi-account"></i><span>Profile</span></a></li>
            <?php
                }
                else
                {
            ...
            <?php
                ...
                {
            ?>
                <li class="open_top"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-accounts-alt"></i><span>Users</span></a>
                <ul class="ml-menu">
                

                    <?php
                    if($_SESSION['user_role_id'] == '2' || $_SESSION['user_role_id'] == '3' || $_SESSION['user_role_id'] == '4')
                    {
                        ?>
                        <li><a href="users-list.php">Users List</a></li>
                        <li><a href="user-add.php">Add User</a></li>
                        <li><a href="user-search.php">Search User</a></li>
                    <?php
                    }
                    else
                    {
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-city"></i><span>Companies</span></a>
                <ul class="ml-menu">
                    ...
                    <?php
                        ...
                        {
                    ?>
                            <li><a href="companies-list.php">Companies List</a></li>
                            <li><a href="company-add.php">Add Company</a></li>
                            <li><a href="company-search.php">Search Company</a></li>
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-invert-colors"></i><span>Chemicals</span></a>
                <ul class="ml-menu">
                    <li><a href="chemicals-list.php">Chemicals List</a></li>
                    <li><a href="chemicals-add-new.php">Add Chemical</a></li>
                  
                   
                                       
                </ul>
            </li>
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-receipt"></i><span>38.3 Certificates</span></a>
                <ul class="ml-menu">
                    ...
                    {
                    ?>
                        <li><a href="38.3-certificate.php">Certificates</a></li>
                        <li><a href="cert-add.php">Add 38.3 Certificate</a></li>
                    <?php
                    }
                    else
                    {
                    ...
                    <li><a href="cert-lists.php">38.3 Certificates List</a></li>
                    <li><a href="38.3-certificate.php">Certificates</a></li>
                    <li><a href="cert-add.php">Add 38.3 Certificate</a></li>
                    <?php
                    }
            ...
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-receipt"></i><span>Blogs</span></a>
                <ul class="ml-menu">
                    ...
                    {
                    ?>
                        <li><a href="bloglist.php">List of Blog Articles</a></li>
                    <?php
                    }
                    else
                    {
                        ...
                        {
                            ?>
                        <li><a href="blog-list-table.php">List of <!--Posted--> Blogs</a></li>
                        <li><a href="blog-list-draft.php">List of Unposted Blogs</a></li>
                        <li><a href="create-new-blog.php">Create New Blog</a></li>
                        <?php
                        }else
                        {
                            ?>
          ...
          <!--  <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-label-heart"></i><span>Label</span></a>
                <ul class="ml-menu">
                    <li><a href="label-search.php">Label List</a></li>
                    <li><a href="label-search.php">Search Label</a></li>
             
                </ul>
            </li>-->
            <!--
            <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-format-color-text"></i><span>Phrasetext</span></a>
                <ul class="ml-menu">
                    <li><a href="phrasetext-search.php">Search Phrasetext</a></li>
             
                </ul>
            </li>
        -->
             <li> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>Density Calculator</span></a>
                <ul class="ml-menu">
                    <li><a href="calc-density.php">Calculate Density</a></li>
                    <li><a href="calc-volume.php">Calculate Volume</a></li>
                    <li><a href="calc-mass.php">Calculate Mass</a></li>
                  
                </ul>
            </li>
             <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-info"></i><span>Information</span></a>
                <ul class="ml-menu">
                    <li><a href="http://www.rimpidopacificinc.com#about" rel="noopener noreferrer" target="_blank">About Us</a></li>
                    <!--<li><a href="info-general.php">General Information</a></li>-->
                    <li><a href="http://www.rimpidopacificinc.com#contact" rel="noopener noreferrer" target="_blank">Contact Us</a></li>
                    <li><a href="data-privacy.php" rel="noopener noreferrer" target="_blank">Privacy Policy</a></li>
                </ul>
            </li>
            <!--
...
<aside id="rightsidebar" class="right-sidebar">
    <ul class="nav nav-tabs sm">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#setting"><i class="zmdi zmdi-settings"></i></a></li>
