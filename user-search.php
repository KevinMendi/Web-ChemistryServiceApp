...
<title>:: ChemPO :: User Search</title>
                                            ...
                                            ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                                ...
                                                                <button type="submit" class="btn btn-sm btn-outline-info waves-effect" name="editUser" value="<?php echo $row['user_id']; ?>"><i class="zmdi zmdi-edit" ></i>&nbsp;Edit</button> &nbsp;
...
function gotoAction(action_name) {
   ...
   if(action_name == "view"){
       document.getElementById('userAction').action = "user-view.php";
       document.getElementById('userAction').submit();
   }else if(action_name == "edit"){
       document.getElementById('userAction').action = "user-edit.php";
       document.getElementById('userAction').submit();
   }
}
</script>
