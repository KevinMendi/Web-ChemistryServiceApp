...
$pdf->writeHTMLCell(35, '', 2, 14, $un_num, 0, 0, 1, true, 'J', true);
...
$pdf->writeHTMLCell(45, '', 2, 93, $reach_num, 0, 0, 1, true, 'J', true);
$pdf->writeHTMLCell(45, '', 2, 96, $ufi_num, 0, 0, 1, true, 'J', true);
