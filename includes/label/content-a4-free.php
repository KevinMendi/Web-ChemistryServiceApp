...
$pdf->writeHTMLCell(40, '', 2, 15, $un_num, 0, 0, 1, true, 'J', true);
...
$pdf->writeHTMLCell(140, '', 2, 28, $signalWord, 0, 0, 1, true, 'J', true);

$pdf->writeHTMLCell(60, '', 2, 195, $reach_num, 0, 0, 1, true, 'J', true);
$pdf->writeHTMLCell(60, '', 2, 200, $ufi_num, 0, 0, 1, true, 'J', true);
