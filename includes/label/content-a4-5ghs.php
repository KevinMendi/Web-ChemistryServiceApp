<?php
$chemName = '<p><b style="font-size:22px">'.htmlspecialchars($chemicalName).'</b></p>';
/*
...
$pdf->writeHTMLCell(55, '', 75, 195, $reach_num, 0, 0, 1, true, 'J', true);
$pdf->writeHTMLCell(55, '', 75, 200, $ufi_num, 0, 0, 1, true, 'J', true);
