...
$pdf->writeHTMLCell(159, '', '', $y, $left_column,0, 0, 1, true, 'J', true);
/*
$pdf->SetXY(65, 35);
...
$pdf->SetXY(159, 60);
$pdf->Image('images/'.$secondGhs.'.png', '', '', 30, 30, '', '', '', false, 300, '', false, false, 1, false, false, false);
$pdf->SetXY(170, 40);
$pdf->Image('images/'.$thirdGhs.'.png', '', '', 30, 30, '', '', '', false, 300, '', false, false, 1, false, false, false);

$pdf->SetXY(170, 80);
$pdf->Image('images/'.$fourthGhs.'.png', '', '', 30, 30, '', '', '', false, 300, '', false, false, 1, false, false, false);

$pdf->SetXY(159, 93);
$pdf->Image('images/'.$fifthGhs.'.png', '', '', 30, 30, '', '', '', false, 300, '', false, false, 1, false, false, false);

*/
$pdf->SetXY(178, 30);
$pdf->Image('images/'.$firstGhs.'.png', '', '', 25, 25, '', '', '', false, 300, '', false, false, 1, false, false, false);
//$pdf->SetXY(190, 70);
//$pdf->Image('images/GHS01.jpg', '', '', 40, 40, '', '', '', false, 300, '', false, false, 1, false, false, false);
$pdf->SetXY(165, 43);
$pdf->Image('images/'.$secondGhs.'.png', '', '', 25, 25, '', '', '', false, 300, '', false, false, 1, false, false, false);

$pdf->SetXY(178, 82);
$pdf->Image('images/'.$thirdGhs.'.png', '', '', 25, 25, '', '', '', false, 300, '', false, false, 1, false, false, false);

$pdf->SetXY(165, 95);
$pdf->Image('images/'.$fourthGhs.'.png', '', '', 25, 25, '', '', '', false, 300, '', false, false, 1, false, false, false);

$pdf->SetXY(178, 56);
$pdf->Image('images/'.$fifthGhs.'.png', '', '', 25, 25, '', '', '', false, 300, '', false, false, 1, false, false, false);
