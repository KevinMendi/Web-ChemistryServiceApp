            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Calculate for Volume</a></li>
                       ...
                       <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="col-md-12 mb-5">
                                    <input type="text" class="form-control"  name="volumeResult" style="height: 70px;font-size: 17px; color:white;" readonly value="<?php echo($answerStr); ?>">
                                </div>
                                ...
                                <div class="row mt-3 ">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" style="color:white;" class="form-control"  name="massValue"  required value="<?php echo($g_mass); ?>">
                                    </div>
                                    <div class="col-md-6">
