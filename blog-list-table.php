                                    ...
                                    <tbody>
                                        ...
                                        foreach ($rows as $row)
                                        {
                                            ?>
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-danger passingID" data-id="<?php echo $row["post_ID"]; ?>"><i class="zmdi zmdi-edit" ></i>&nbsp;Delete</button> &nbsp;
                                                </th>
                                                </tr>
                                            <?php
                                        }
    ...
    <div class="modal-dialog modal-dialog-centered">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <i><small>Are you sure you want to delete this blog post?<br>
        You can view the deleted/draft blog posts on View Unposted Blogs page.</small></i><br>
